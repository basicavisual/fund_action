...
ActiveRecord::Schema.define(version: 2026_07_08_101210) do
  ...
  create_table "decidim_admin_authorizer_authorizations", force: :cascade do |t|
    ...
    t.index ["expires_at"], name: "index_decidim_admin_authorizer_authorizations_on_expires_at"
    t.index ["user_id"], name: "index_decidim_admin_authorizer_authorizations_on_user_id"
  end
  ...
  add_foreign_key "decidim_admin_authorizer_authorizations", "decidim_users", column: "user_id"
