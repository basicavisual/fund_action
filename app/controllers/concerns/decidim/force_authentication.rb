...
module Decidim
  ...
  module ForceAuthentication
    ...
    def allow_unauthorized_path?
      return true if unauthorized_paths.include? params[:controller]
    ...
    def unauthorized_paths
      ...
      %w(decidim/locale decidim/cookies decidim/homepage decidim/pages) + Decidim::StaticPage.where(
        organization: current_organization,
        allow_public_access: true
      ).pluck(Arel.sql("CONCAT('decidim', '/pages/', slug)"))
    end
  end
end
